		...
		function addAccessKeyResults(lastRotated, keyNum, arn, userCreationTime) {
			...
			if (helpers.functions.daysAgo(userCreationTime) > 180 &&
				...
				helpers.addResult(results, 0,
					...
					((lastRotated === 'N/A') ? 'has never been rotated but user is only ' + helpers.functions.daysAgo(userCreationTime) + ' days old' : 'was last rotated ' + helpers.functions.daysAgo(lastRotated) + ' days ago'), arn)
			}
