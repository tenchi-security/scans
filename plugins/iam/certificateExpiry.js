...
module.exports = {
	...
	run: function(cache, includeSource, callback) {
		...
		var listServerCertificates = (cache.iam &&
									  cache.iam.listServerCertificates &&
									  cache.iam.listServerCertificates[region]) ?
									  cache.iam.listServerCertificates[region] : null;
		...
		if (includeSource) {
			source = {
				listServerCertificates: (cache.iam && cache.iam.listServerCertificates) ?
								 		 cache.iam.listServerCertificates : null
			}
		}
